...
// Os dados ficam em ~/.ep-digital-db (fora do projeto, para não disparar o hot-reload do Next
...
const dir = path.resolve(process.env.LOCAL_DB_DIR || path.join(os.homedir(), ".ep-digital-db"));
const port = Number(process.env.LOCAL_DB_PORT || 5433);
const user = "ep";
const password = "ep_dev_password";
const database = "ep_digital";
